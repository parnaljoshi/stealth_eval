...
def parse_args():
    ...
    parser.add_argument("--extract_col_list", help="List of the columns to be extracted", nargs = '+', default = "DB Object ID Qualifier GO ID Evidence Code Aspect")
    parser.add_argument('--no_dup', action='store_true', help='Enables removal of duplicates')
    parser.add_argument('--no_neg', action='store_true', help='Enables removal of annotations with negative Qualifier') 
    parser.add_argument("--evidience_codes", help="List of the evidence codes to be included", nargs = '+', default = "EXP IDA IPI IMP IGI IEP TAS IC")
    parser.add_argument("--highTP", action='store_true', help="Include high throughput evidence codes")
    parser.add_argument("--out_path", type=str, help="Path of the extracted file", default = "extracted.tsv")
